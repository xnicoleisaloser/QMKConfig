 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | LCtrl|PrntSn| LGUI | LAlt | Lower| Space| Enter| Raise| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_ortho_4x12(
    ...
    KC_LCTL, KC_PSCR, KC_LGUI, KC_LALT, MO(_LOWER), KC_SPC,   KC_ENT,   MO(_RAISE), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_ortho_4x12(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS, KC_MPLY, KC_TRNS,    KC_MPRV,    KC_VOLD, KC_VOLU, KC_MNXT
),
...
[_ADJUST] = LAYOUT_ortho_4x12(
    ...
    KC_NO,    KC_NO,    KC_NO,    KC_APP,    KC_LEFT,    KC_DOWN,    KC_UP,    KC_RIGHT,    KC_APP,    KC_NO,    KC_NO, KC_NO,
